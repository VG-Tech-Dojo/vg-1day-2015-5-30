...
class Message {
    ...
    init?(dictionary: [String: AnyObject]) {
        ...
        if let body: String = dictionary["body"] as? String, let icon: String = dictionary["icon"] as? String, let time: String = dictionary["created_at"] as? String, let username: String = dictionary["username"] as? String {
            self.body = body
